...
const AboutUs = ({setSelectedPage}: Props) => {
  ...
  return (
    <section id='aboutus' className='mx-auto min-h-full w-full pt-28 pb-0'>
      <motion.div 
      ...
      {/* Contenido de la sección */}
        <div className='py-10 text-black text-lg leading-relaxed'>
          <div className='mb-8'>
            <h2 className='text-3xl font-semibold mb-2'>Next Level Labs: Pioneers in Cannabis Extraction and Consulting</h2>
            <p>
          ...
          <div className='mb-8'>
            <h3 className='text-2xl font-semibold mb-2'>Values and Principles</h3>
          ...
          <div>
            <h3 className='text-2xl font-semibold mb-2'>Why Choose Next Level Labs?</h3>
            <p>
